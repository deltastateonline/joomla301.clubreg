			...
			<?php foreach($activity as $an_activity){ 
				...
				<div class="row-fluid">
					...
					<div class="content-here">
						<div class='<?php echo $activity_class; ?> pull-left'><?php echo ucwords($an_activity->activity_item); ?></div>
						<a href='javascript:void(0);' class='pull-right img_hidden' title='Show Details' <?php echo $rel_string_edit; ?> ><img src="<?php echo CLUBREG_ASSETS; ?>/images/down.png" class=""/></a>
						<div class="clearfix"></div>
					</div>
					<?php } ?>					
				</div>
