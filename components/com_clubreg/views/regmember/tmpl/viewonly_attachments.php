...
<form action="index.php" method="post" name="attachmentForm" id="attachment-form" class="form-validate form-horizontal">
...
<button type="submit" class="btn btn-primary validate"><span><?php echo JText::_('JATTACHMENT'); ?></span></button>
