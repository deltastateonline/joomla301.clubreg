...
?>
	...
	<div class="frame-div span6">
			<div class="h21"><?php echo JText::_('COM_CLUBREG_PROFILE_BIO'); ?> : </div>
					...
					<div class="row-fluid">
						<div class="pull-left profile-label1"><?php echo JText::_('JTAG')?></div>
						<div class="pull-left" style='padding:0px 5px;'> : </div>
						<div class="pull-left profile-value"> 
						<?php foreach($tags as $atag){  echo sprintf("<span class='label label-success'>%s</span> &nbsp;",$this->searchTags[$atag]); }?>
						</div>
					</div>
