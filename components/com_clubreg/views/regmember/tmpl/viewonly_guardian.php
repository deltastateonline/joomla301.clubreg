...
?>
<div><a class="btn profile-guardian-button btn-mini btn-info" href="javascript:void(0)" rel=<?php echo json_encode($rel_string_edit)?>><?php echo JText::_('COM_CLUBREG_PROFILE_EDITGUARDIAN')?></a></div>
