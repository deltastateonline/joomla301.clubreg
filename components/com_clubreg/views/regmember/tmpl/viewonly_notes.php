...
<div class="clugreg-div well well-small profile-well" id="noteFormDiv">
-------------------------------------------------------------------------*/ 
// no direct access
...
<div class="clugreg-div-wrapper">
	<div class="clugreg-div" id="noteFormDiv">
	<form action="index.php" method="post" name="NoteForm" id="note-form" class="form-validate form-clubreg">	
		...
		<div class="form-actions">				
			...
			<button type="button" class="btn profile-note-button-cancel"><span><?php echo JText::_('JCANCEL'); ?></span></button>			
		</div>
	</form>
	</div>
	<div class="clugreg-div loading1 row-striped" id="profile-notes" rel=<?php echo json_encode($rel_string)?>></div>
</div>
