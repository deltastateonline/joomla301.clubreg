...
?>
<div><a class="btn profile-property-button" href="javascript:void(0)" rel=<?php echo json_encode($rel_string_edit)?>>Add <?php echo JText::_('COM_CLUBREG_PROFILE_PROPERTY')?></a></div>
