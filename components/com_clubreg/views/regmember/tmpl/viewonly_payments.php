...
?>
<div><a class="btn profile-payment-button btn-mini btn-info" href="javascript:void(0)" rel=<?php echo json_encode($rel_string_edit)?>>Add <?php echo JText::_('COM_CLUBREG_PROFILE_PAYMENT')?></a></div>
