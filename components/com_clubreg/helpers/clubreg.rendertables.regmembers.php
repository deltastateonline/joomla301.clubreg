...
class ClubRegRenderDivsRegMembersHelper extends ClubRegRenderTablesHelper
{
			  ...
			  if(count($viewObject->items) > 0){
			    ...
			    <div class="row cgroup-div" style="margin:7px 5px 7px 10px;">		    
			     <div class="pull-left">
			     	...
			     	<?php if(in_array($an_item->member_status,$this->otherconfigs["allowedstatus"]) &&  in_array($an_item->playertype,$this->otherconfigs["checkboxes"])){ 
			    	 		 echo JHtml::_('grid.id', $i, $an_item->member_id);  } ?><span class="pull-right numbering"><?php echo $i+1 ; ?>	</span>
