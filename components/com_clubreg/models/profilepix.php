...
class ClubregModelProfilepix extends JModelForm
{
	...
	protected $_context = 'com_clubreg.profilepix';
	
	public function getForm($data = array(), $loadData = true)
	{
		// Get the form.		
		$form = $this->loadForm('com_clubreg.profilepix', 'profilepix', array('control' => 'jform', 'load_data' => true));		
		if (empty($form)) {
			return false;
		}
		return $form;
	...
	public function getTable($type = 'Profilepix', $prefix = 'ClubregTable', $config = array())
	{
	...
	{
		$data = (array) JFactory::getApplication()->getUserState('com_clubreg.profilepixprofilepix.data', array());
		if (empty($data)) {
				
		}
		$data["member_key"] = $this->getState("com_clubreg.profilepix.member_key");
		$data["link_type"] = $this->getState("com_clubreg.profilepix.link_type");
		return $data;
	}
	...
	public function changeStatus($status){
		...
		$attachment_id = $this->getState("com_clubreg.profilepix.attachment_id");
		$attachment_key = $this->getState("com_clubreg.profilepix.attachment_key");		
