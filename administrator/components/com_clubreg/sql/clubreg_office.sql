...
--
-- Host: localhost
-- Generation Time: Nov 05, 2012 at 05:57 AM
...
--
-- Table structure for table `l6fbk_clubreg_contact_details`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_contact_details` (
...
--
-- Dumping data for table `l6fbk_clubreg_contact_details`
--

INSERT INTO `l6fbk_clubreg_contact_details` (`member_id`, `contact_detail`, `contact_value`) VALUES
(10, 'em_address', ''),
(10, 'em_emailaddress', ''),
(10, 'em_givenname', ''),
(10, 'em_medical', ''),
...
--
-- Table structure for table `l6fbk_clubreg_details_audit`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_details_audit` (
...
--
-- Dumping data for table `l6fbk_clubreg_details_audit`
--

INSERT INTO `l6fbk_clubreg_details_audit` (`id`, `primary_id`, `short_desc`, `audit_details`, `created_date`, `created_time`, `createdby`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_eoimembers`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_eoimembers` (
...
--
-- Dumping data for table `l6fbk_clubreg_eoimembers`
--

INSERT INTO `l6fbk_clubreg_eoimembers` (`member_id`, `surname`, `givenname`, `mobile`, `address`, `suburb`, `postcode`, `phoneno`, `emailaddress`, `send_news`, `dob`, `group`, `as_above`, `gender`, `created`, `created_by`, `approved`, `approved_by`, `year_registered`, `member_status`, `parent_id`, `playertype`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_groups`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_groups` (
...
--
-- Dumping data for table `l6fbk_clubreg_groups`
--

INSERT INTO `l6fbk_clubreg_groups` (`group_id`, `group_name`, `group_short`, `group_text`, `group_type`, `which_config`, `group_comments`, `group_leader`, `createdby`, `created`, `ordering`, `publish`, `params`, `group_parent`, `checked_out`, `checked_out_time`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_notes`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_notes` (
...
--
-- Dumping data for table `l6fbk_clubreg_notes`
--

INSERT INTO `l6fbk_clubreg_notes` (`note_id`, `member_id`, `notes`, `created`, `created_by`, `note_status`, `note_type`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_payments`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_payments` (
...
--
-- Dumping data for table `l6fbk_clubreg_payments`
--

INSERT INTO `l6fbk_clubreg_payments` (`payment_id`, `member_id`, `payment_method`, `payment_transact_no`, `payment_status`, `payment_date`, `payment_season`, `payment_desc`, `payment_notes`, `payment_amount`, `created`, `created_by`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_registeredmembers`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_registeredmembers` (
  `member_id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `l6fbk_clubreg_registeredmembers`
--

INSERT INTO `l6fbk_clubreg_registeredmembers` (`member_id`, `memberid`, `memberlevel`, `surname`, `givenname`, `mobile`, `address`, `suburb`, `postcode`, `phoneno`, `emailaddress`, `send_news`, `dob`, `group`, `subgroup`, `as_above`, `gender`, `created`, `created_by`, `approved`, `approved_by`, `year_registered`, `member_status`, `parent_id`, `playertype`, `eoi_id`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_saved_comms`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_saved_comms` (
...
--
-- Dumping data for table `l6fbk_clubreg_saved_comms`
--

INSERT INTO `l6fbk_clubreg_saved_comms` (`comm_id`, `template_id`, `comm_groups`, `comm_subject`, `comm_message`, `created`, `created_by`, `comm_status`, `sent_date`, `sent_by`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_stats_details`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_stats_details` (
  `member_id` int(11) NOT NULL,
...
--
-- Dumping data for table `l6fbk_clubreg_stats_details`
--

INSERT INTO `l6fbk_clubreg_stats_details` (`member_id`, `stats_date`, `stats_detail`, `stats_value`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_tags`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_tags` (
...
--
-- Dumping data for table `l6fbk_clubreg_tags`
--

INSERT INTO `l6fbk_clubreg_tags` (`tag_id`, `tag_text`, `published`, `created_date`, `created_time`, `createdby`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_tags_players`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_tags_players` (
...
--
-- Dumping data for table `l6fbk_clubreg_tags_players`
--

INSERT INTO `l6fbk_clubreg_tags_players` (`tag_id`, `member_id`) VALUES
(1, 23),
(1, 37),
(1, 43),
(1, 45),
...
--
-- Table structure for table `l6fbk_clubreg_teammembers`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_teammembers` (
...
--
-- Dumping data for table `l6fbk_clubreg_teammembers`
--

INSERT INTO `l6fbk_clubreg_teammembers` (`joomla_id`, `status`, `params`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_teammembers_details`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_teammembers_details` (
  `joomla_id` int(11) NOT NULL,
...
--
-- Dumping data for table `l6fbk_clubreg_teammembers_details`
--

INSERT INTO `l6fbk_clubreg_teammembers_details` (`joomla_id`, `member_detail`, `member_value`) VALUES
...
--
-- Table structure for table `l6fbk_clubreg_teammembers_groups`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_teammembers_groups` (
  `joomla_id` int(11) NOT NULL,
...
--
-- Dumping data for table `l6fbk_clubreg_teammembers_groups`
--

INSERT INTO `l6fbk_clubreg_teammembers_groups` (`joomla_id`, `group_id`, `status`) VALUES
(62, 1, 1),
(62, 2, 1),
(62, 3, 0),
(62, 14, 0),
...
--
-- Table structure for table `l6fbk_clubreg_templates`
--

CREATE TABLE IF NOT EXISTS `l6fbk_clubreg_templates` (
...
--
-- Dumping data for table `l6fbk_clubreg_templates`
--

INSERT INTO `l6fbk_clubreg_templates` (`template_id`, `template_name`, `template_subject`, `template_text`, `template_ptext`, `template_status`, `template_type`, `template_access`, `created`, `created_by`, `checked_out`, `checked_out_time`, `published`, `ordering`, `params`) VALUES
