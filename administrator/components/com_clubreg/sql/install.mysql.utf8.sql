...
CREATE TABLE `#__clubreg_registeredmembers` (
	`member_id` INT(11) NOT NULL AUTO_INCREMENT,
	`member_key` VARCHAR(30) NOT NULL,
	`memberid` VARCHAR(50) NULL DEFAULT ' ' COMMENT 'Member Club Id Number',
	`memberlevel` VARCHAR(50) NULL DEFAULT ' ' COMMENT 'Member Club level',
	`surname` VARCHAR(30) NULL DEFAULT NULL,
	`givenname` VARCHAR(30) NULL DEFAULT NULL,
	`mobile` VARCHAR(30) NULL DEFAULT NULL,
	`address` VARCHAR(50) NULL DEFAULT NULL,
	`suburb` VARCHAR(30) NULL DEFAULT NULL,
	`ausstate` VARCHAR(3) NULL DEFAULT NULL,
	`postcode` VARCHAR(30) NULL DEFAULT NULL,
	`phoneno` VARCHAR(30) NULL DEFAULT NULL,
	`emailaddress` VARCHAR(50) NULL DEFAULT NULL,
	`send_news` TINYINT(4) NULL DEFAULT NULL,
	`postal_address` VARCHAR(50) NULL DEFAULT NULL,
	`dob` DATE NULL DEFAULT NULL,
	`group` INT(11) NULL DEFAULT NULL,
	`subgroup` INT(11) NULL DEFAULT '-1',
	`as_above` TINYINT(4) NULL DEFAULT NULL,
	`gender` VARCHAR(6) NULL DEFAULT NULL,
	`created` DATETIME NULL DEFAULT NULL,
	`created_by` INT(11) NULL DEFAULT NULL,
	`approved` DATETIME NULL DEFAULT NULL,
	`approved_by` INT(11) NULL DEFAULT NULL,
	`joining_date` DATE NULL DEFAULT '0000-00-00',
	`year_registered` YEAR NULL DEFAULT NULL,
	`member_status` VARCHAR(30) NULL DEFAULT NULL,
	`parent_id` INT(11) NULL DEFAULT NULL,
	`playertype` VARCHAR(11) NULL DEFAULT NULL,
	`eoi_id` INT(11) NULL DEFAULT NULL,
	PRIMARY KEY (`member_id`),
	INDEX `parent_id` (`parent_id`),
	INDEX `group` (`group`),
	INDEX `gender` (`gender`),
	INDEX `playertype` (`playertype`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
