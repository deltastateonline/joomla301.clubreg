...
class ClubRegHelper
{
	...
	public static function addSubmenu($vName){
		...
		JHtmlSidebar::addEntry(
				JText::_('COM_CLUBREG_SUBMENU_VALIDATEAPP'),
				'index.php?option=com_clubreg&layout=validateapp',
				$vName == 'validateapp'
		);	
	...
	static function write_analytics(){
		?><script>
